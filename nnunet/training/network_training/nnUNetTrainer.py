...
class nnUNetTrainer(NetworkTrainer):
        ...
        if fold is not None:
            if isinstance(fold, str):
                ...
                if self.output_folder.endswith("fold_%s" % str(self.fold)):
                    self.output_folder = self.output_folder_base
                self.output_folder = join(self.output_folder, "fold_normal_%s" % str(fold)) # TODO  modify output folder
            self.fold = fold
    ...
    def get_basic_generators(self):
        ...
        if self.threeD:
            ...
            dl_val = DataLoader3D(self.dataset_val, self.patch_size, self.patch_size, self.batch_size, False,
                                  ...
                                  pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r', is_val=True)
        else:
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        pred_gt_tuples = []
        default_num_threads = 4 # todo edit default_num_threads
        ...
        for k in self.dataset_val.keys():
            ...
            if overwrite or (not isfile(join(output_folder, fname + ".nii.gz"))) or \
                ...
                softmax_pred = self.predict_preprocessed_data_return_seg_and_softmax(data, # todo modify data[:-1]
