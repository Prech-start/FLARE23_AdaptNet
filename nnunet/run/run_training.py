...
def main():
    ...
    parser.add_argument("--disable_saving", required=True, action='store_true',
    ...
    if args.disable_saving:
        ...
        trainer.save_best_checkpoint = True  # whether or not to save the best checkpoint according to
        # self.best_val_eval_criterion_MA
        trainer.save_intermediate_checkpoints = True  # whether or not to save checkpoint_latest. We need that in case
        # the training chashes
        trainer.save_latest_only = False  # if false it will not store/overwrite _latest but separate files ea0ch
